...
import { ArrowLeft, Users, FileText, Check, X, ChevronDown, ChevronUp, Download, RefreshCw, SlidersHorizontal, Info } from 'lucide-react';
...
type Tab = 'submissions' | 'users' | 'settings';
